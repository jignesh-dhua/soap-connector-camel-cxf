...
/**
 * Creates a custom truststore which automatically accepts all incoming
 * certificates.
 * <p/>
 * Note that this is rather insecure but due to the inflexibility to add or
 * chain truststores with unstrusted/self-signed certificates at runtime, this
