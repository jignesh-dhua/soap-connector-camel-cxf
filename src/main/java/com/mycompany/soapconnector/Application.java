...
//	    System.setProperty("javax.net.ssl.keyStorePassword", "damith");
		...
		clientStore.load(new FileInputStream(new File("/home/ubuntu/keystore.ImportKey")), "damith".toCharArray());
		...
		trustStore.load(new FileInputStream("/home/ubuntu/keystore.ImportKey"), "damith".toCharArray());
